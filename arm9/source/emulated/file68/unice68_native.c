...
#define GET_1_BIT_BCC(LABEL) B_CC(get_1_bit(R)==0, LABEL)
...
static int check_drange(all_regs_t *R, const areg_t a, const areg_t b)
{
...
static int check_crange(all_regs_t *R, const areg_t a, const areg_t b)
{
...
/* 	dbf	d1,getbytes */
/* 	rts */
static int getinfo(all_regs_t *R)
{
  int r0 =
    (0[R->a0] << 24)
    + (1[R->a0] << 16)
...
static int get_1_bit(all_regs_t *R)
{
  int r;
